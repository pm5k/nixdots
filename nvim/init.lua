-- Import a list of languages for Treesitter.
...
-- Essentially allowing you to skip wrapped lines like so:
--
-- "The quick brown fox jumps"
-- "over the lazy"
-- "dog."
--
-- If using k/j - the cursor would move one line down if this sentence was wrapped.
-- However if you use gk/gj it will move down as if this sentence was all on one line.
...
-- Call Glow to render MD files..
-- vim.keymap.set('n', '<leader>g', ':Glow<CR>', { desc = 'Preview markdown with Glow' })
...
-- FIXME: OrganiseImports Using Ruff
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          ...
          -- FIXME: we disable space in normal and visual, so this won't be of use..
